return {
  ...
  config = function()
    ...
    wk.add({
      ...
      { "<leader>xx", ":Trouble diagnostics toggle<CR>", desc = "⚠️ Toggle diagnostics" },
      { "<leader>xw", ":Trouble diagnostics toggle<CR>", desc = "⚠️ Workspace diagnostics" },
      { "<leader>xd", ":Trouble diagnostics toggle filter.buf=0<CR>", desc = "⚠️ Document diagnostics" },
      { "<leader>xq", ":Trouble qflist toggle<CR>", desc = "📋 Quickfix list" },
      { "<leader>xl", ":Trouble loclist toggle<CR>", desc = "📍 Location list" },
      { "<leader>xs", ":Trouble symbols toggle<CR>", desc = "🏷️ Document symbols" },
      { "]x", function() require("trouble").next({ skip_groups = true, jump = true }) end, desc = "➡️ Next trouble item" },
      { "[x", function() require("trouble").prev({ skip_groups = true, jump = true }) end, desc = "⬅️ Previous trouble item" },
